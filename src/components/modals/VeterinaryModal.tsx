...
export default function VeterinaryModal({ setShowVetModal }: VeterinaryModuleProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(`${process.env.PROTOCOL}://${process.env.VERCEL_URL}/api/vet/use-code`, {
        method: "POST",
