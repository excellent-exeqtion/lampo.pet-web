...
export async function POST(req: NextRequest) {
    try {
        ...
        const { matricula, firstLastName, secondLastName } = body as { matricula?: string, firstLastName: string, secondLastName: string };
        ...
        const { data, error } = await ComvezcolRepository.validate(matricula, firstLastName.trim(), secondLastName.trim());
